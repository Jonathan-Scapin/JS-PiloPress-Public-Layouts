...
$scroll_wrapper_main_transparent_vars  = acf_maybe_get( $css_vars, 'scroll-wrapper-main-transparent' );
...
$sticky_menu      = get_sub_field( 'sticky' );
?>
    <header data-has-bg="<?php echo (bool) $section_bg_color; ?>" class="<?php echo $layout_name . ' ' . $sticky_menu;?>">
        <div class="container <?php echo $section_bg_color ? 'wrapper-main-color ' . $wrapper_main_color_vars : 'wrapper-main-transparent ' . $wrapper_main_transparent_vars; ?>">
            <div class="inner-wrapper-main <?php echo $inner_wrapper_main_vars; ?>">
                ...
                <nav
                    ...
                    wp_nav_menu(
                        array(
                            'theme_location' => 'menu_contained_seabass',
                            'container'      => 'ul',
                            'menu_id'        => 'desktop',
