...
$background_parallax                 = acf_maybe_get( $css_vars, 'background-parallax' );
...
<section class="<?php echo $layout_name; ?>">
    ...
    if ( $bg_img ) : ?>
        ...
        class="<?php echo $background_parallax;?>" 
        style="background-image: url('<?php echo acf_maybe_get( $bg_img, 'url' ); ?>');">
        </div>
    ...
    // Content
    if ( $content ) : ?>
    <div class="absolute top-0 wrapper-content <?php echo $wrapper_content_vars; ?>" style="min-height: <?php echo $hero_height; ?>;">
