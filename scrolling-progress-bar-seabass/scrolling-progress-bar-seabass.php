...
?>
<section id="contain-progress-bar" class="<?php echo "$layout_name $content_wrapper_vars" ?>">

    <div class="progress-container <?php echo $bg_color_contain_vars . ' ' . $empty_bar_color; ?>" style="min-height: <?php echo $bar_height; ?>">
        <div id="progress-bar" class="<?php echo $bg_color_progress_vars . ' ' . $progress_bar_color; ?>" style="min-height: <?php echo $bar_height; ?>"></div>
    </div>
